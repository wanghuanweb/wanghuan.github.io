...
1.new一个XMLHttpRequest对象，创建http请求并且发送http请求，send的数据为FormData构造函数
2.用已有的form元素初始化FormData对象，将已有的form元素作为参数传给FormData构造函数


```
<form enctype="multipart/form-data" method="post" id="myFormElement">
